...
OFILES = main.o myLib.o text.o font.o title.o leftBorder.o rightBorder.o ball.o endScreen.o levelScreen.o

# The header files you have created.
# This is necessary to determine when to recompile for files.
# This should be a space (SPACE!) separated list of .h files
HFILES = myLib.h text.h title.h leftBorder.h rightOrder.h ball.h endScreen.h levelScreen.h
